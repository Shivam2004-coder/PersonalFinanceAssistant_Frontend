...
import { addRangeSearch, resetRangeSearch } from '../../../utils/ReduxStore/currentSearchSlice';
...
//   });
  ...
  const handleSaveClick = async () => {
    dispatch(resetRangeSearch());
    await handleRangeSearch(form, setForm,1,dispatch,addRangeSearch);
  } ;
