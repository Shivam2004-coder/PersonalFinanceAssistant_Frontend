...
import { setExpVsDataSearch } from "../../../utils/ReduxStore/graphSlice";
...
const ExpenseVsData = () => {
  ...
  const expVsDataSearch = useSelector((store) => store.graph.expVsDataSearch);
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center cursor-pointer">
        <h2 className="font-bold text-lg">Expenses vs Income</h2>
        <button
      ...
      {isOpen && (
        <div className="mt-4 flex flex-col gap-6">
          ...
          <div className="flex flex-wrap gap-8 justify-center">
              <GraphPie graphData={expVsDataSearch} which={"expenseVsData"} />

              <GraphBar graphData={expVsDataSearch} which={"expenseVsData"} />

              <GraphLine graphData={expVsDataSearch} which={"expenseVsData"} />
